...
@interface FunFaceViewController : UIViewController <UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate> {
...
- (void) uploadFace: (CGImageRef) aFaceImageRef;
